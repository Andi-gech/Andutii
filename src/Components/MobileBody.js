    ...
    <>
      ...
      >
        ...
        <div className="MobileBodyImage">
          <img src={prof1} onLoad={() => setimageloaded(true)} />
        </div>
            ...
            <Typewriter
              ...
              onInit={(typewriter) => {
                typewriter
                  ...
                  .deleteAll()
                  .typeString(
                    "<span id='typemobilespink'>Mobile-app dev</span>"
                  )
                  .pauseFor(3000)
                  .start();
              }}
        ...
        <div className="mobileaboutme">
          ...
          <p>
            ...
            class.and taken several courses at Corsera Meta Backend development.
            I am Honest And Reliable ,known with my clean code
          </p>
